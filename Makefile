...
interpreter.o: interpreter.cpp interpreter.hpp check.hpp lang.h
	gcc -c -g interpreter.cpp

main.o: main.cpp lexer.h parser.h lang.h check.hpp
	gcc -c -g main.cpp

main: lang.o parser.o lexer.o lib.o main.o check.o interpreter.o
	gcc -g lang.o parser.o lexer.o lib.o main.o check.o interpreter.o -lstdc++ -o main
